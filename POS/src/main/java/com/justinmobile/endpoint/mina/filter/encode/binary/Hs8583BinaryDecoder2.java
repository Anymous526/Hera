...
public class Hs8583BinaryDecoder2 extends ProtocolDecoderAdapter {   
   private final AttributeKey CONTEXT = new AttributeKey(getClass(), "context");   
   private final Charset charset;   
   private int maxPackLength = 4000;   
 
   public Hs8583BinaryDecoder2() {   
       this(Charset.defaultCharset());   
   }   
 
   public Hs8583BinaryDecoder2(Charset charset) {   
   ...
   @Override
	...
	throws Exception {
       ...
       String len= buf.getString(charset.newDecoder());
       ...
       while (buf.remaining() >= packHeadLength) {   
           ...
           // 读取正常的消息，并写入输出流中，以便IoHandler进行处理   
        	   ...
        	   if (length >= packHeadLength && length - packHeadLength <= buf.remaining()) {   
   ...
   public void dispose(IoSession session) throws Exception {   
    ...
    private class Context {   
        ...
        private Context() {   
            ...
            buf = IoBuffer.allocate(4000).setAutoExpand(true);   
        }   
