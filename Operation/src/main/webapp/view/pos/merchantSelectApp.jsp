...
<html>
	...
	<body>
		...
		<script type='text/javascript' src='${ctx}/view/pos/js/merchantSelectApp.js'></script>
		<script type='text/javascript' src='${ctx}/view/pos/js/listMerchant.js'></script>        
