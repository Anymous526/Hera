...
<html>
	...
	<body>
		...
		<div id="appDiv"></div>                    
		<script type='text/javascript' src='${ctx}/view/cloudboss/merchant/js/listContract.js'></script>
		<script type='text/javascript' src='${ctx}/view/cloudboss/merchant/js/editContract.js'></script>
