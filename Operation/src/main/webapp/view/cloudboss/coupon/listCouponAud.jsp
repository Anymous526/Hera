...
<html>
	...
	<body>
		...
		<script type='text/javascript' src='${ctx}/view/cloudboss/coupon/js/editCoupon.js'></script>
		<script type='text/javascript' src='${ctx}/view/cloudboss/coupon/js/listCouponAud.js'></script>
