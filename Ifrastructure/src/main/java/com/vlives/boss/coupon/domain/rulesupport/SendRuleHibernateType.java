 ...
 */
public class SendRuleHibernateType implements UserType{
	...
	public Object nullSafeGet(ResultSet rs, String[] names, Object owner)
		...
		if (resultStr == null || resultStr.trim().equals(""))
			return null;
		return SendRule.createSendRule(resultStr);
	}
	...
	public void nullSafeSet(PreparedStatement ps, Object value, int index)
		...
		if (value == null) {
			...
			SendRule sendRule = (SendRule) value;
			Hibernate.STRING.nullSafeSet(ps, sendRule.toXml(), index);
		}
	...
	@Override
	public Class<SendRule> returnedClass() {
		return SendRule.class;
	}
