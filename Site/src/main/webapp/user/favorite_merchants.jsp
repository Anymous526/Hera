 ...
 <div class="Bu_content"> 
  <div class="Bu_mapleft">
    ...
    <div class="Map_top" id="merchantsTop" style="height:43px; overflow:hidden;">
     ...
     <div class="Map_nav01">
       <ul>
         <li id="membershipMerchantsLi"><a href="/user/memberMerchants">我的会员</a></li>
         <li class="now" id="favoriteMerchantsLi"><a href="/user/favoriteMerchants">我的收藏</a></li> 
       </ul>
	 </div>
  ...
  <div class="Map_list" id="merchantsDiv">
   <div id="favoriteMerchantsSubDiv">
     <ul id="favoriteMerchantsUl"></ul>
     <div class="manu" id="favpage"></div>
   </div>
  </div>
  </div>
    <!--右边板块--> 
...
window.addEvent("domready",function() {
	...
	//获取我的收藏列表
	com.vlives.member.getFavoriteMerchantList();
});
</script>
</body>
</html>