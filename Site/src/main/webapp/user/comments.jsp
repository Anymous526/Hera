 ...
 <div class="Bu_content"> 
  <div class="Bu_mapleft">
   ...
   <div class="Map_top" id="consumesTop" style="height:43px; overflow:hidden;">
      ...
      <div class="Map_nav01">
        <ul>
          <li id="consumesLi"><a href="/user/consumes">我的消费</a></li>
          <li class="now" id="commentsLi"><a href="/user/comments">我的点评</a></li> 
        </ul> 
      </div>
  ...
  <div class="Con_list" id="consumesDiv"> 
    <div class="C_content" style="border:none;" id="commentsSubDiv">
     <ul id="commentsUl">
     </ul>
...
window.addEvent("domready",function() {
	...
	//获取我的点评列表
	com.vlives.member.getCommentsList();
});
</script>
</body>
</html>
